...
if (isset($_POST['add_product'])) {
   ...
   $select_product_name->execute([':name' => $name]);
   ...
   if ($select_product_name->rowCount() > 0) {
      ...
      $add_product_query->execute([':name' => $name, ':price' => $price, ':image' => $image]);
...
if (isset($_POST['update_product'])) {
   ...
   $update_product_query = $conn->prepare("UPDATE `products` SET name = :name, price = :price WHERE id = :id");
   $update_product_query->execute([':name' => $update_name, ':price' => $update_price, ':id' => $update_p_id]);
   ...
   if (!empty($update_image)) {
      if ($update_image_size > 2000000) {
         ...
         $update_image_query->execute([':image' => $update_image, ':id' => $update_p_id]);
...
<section class="add-products">
   ...
   <h1 class="title">Shop Courses</h1>
